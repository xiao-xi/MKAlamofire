...
public final class MKActivityIndicatorView: UIView {
...
extension MKActivityIndicatorView {
...
extension MKActivityIndicatorView {
    private func initUI() {
        ...
        _textLabel = UILabel()
        _textLabel?.textColor = MKConfig.shared.loadViewTextColor
        _textLabel?.font = MKConfig.shared.loadViewTextFont
        _textLabel?.textAlignment = .center
        _textLabel?.numberOfLines = 0
        _textLabel?.text = MKConfig.shared.loadViewText
...
extension MKActivityIndicatorView {
    ...
    private func reloadViewFrame() {
        ...
        let font = _textLabel?.font ?? MKConfig.shared.loadViewTextFont
...
public final class WBActivityRodllView: UIView {
    ...
    private func initUI() {
        ...
        _shapLayer?.lineCap = CAShapeLayerLineCap.round
        _shapLayer?.lineJoin = CAShapeLayerLineJoin.round
